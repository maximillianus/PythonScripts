...
province_name = 'kalimantan tengah'.upper()
...
for kabupaten_text in kabupaten_links_text[ii:ii+1]:
    # go into each link and go back
    outputname = 'test_KTP_KPU_scrape_' + province_name.replace(' ','_') + '-' + kabupaten_text.replace(' ','_') + '.csv'
